...
from services.reviews_service.app import app as reviews_app, create_review, list_room_reviews, update_review, delete_review, flag_review  # noqa
...
def profile_main():
    ...
    profiler.add_function(unwrap(create_review))
    profiler.add_function(unwrap(list_room_reviews))
    profiler.add_function(unwrap(update_review))
    profiler.add_function(unwrap(delete_review))
    profiler.add_function(unwrap(flag_review))
