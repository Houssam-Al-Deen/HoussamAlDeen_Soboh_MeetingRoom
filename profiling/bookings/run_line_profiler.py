...
from services.bookings_service.app import app as bookings_app, create_booking, list_bookings, update_booking, cancel_booking, force_cancel_booking, check_availability  # noqa
...
def profile_main():
    ...
    profiler.add_function(unwrap(create_booking))
    profiler.add_function(unwrap(list_bookings))
    profiler.add_function(unwrap(update_booking))
    profiler.add_function(unwrap(cancel_booking))
    profiler.add_function(unwrap(force_cancel_booking))
    profiler.add_function(unwrap(check_availability))
